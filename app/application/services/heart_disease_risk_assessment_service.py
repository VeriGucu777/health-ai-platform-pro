"""Heart disease risk assessment application service."""

from datetime import datetime
from uuid import UUID

from app.application.analytics.heart_disease_risk_assessment import build_feature_vector
...
from app.application.dtos.heart_disease_risk_assessment import (
...
from app.domain.interfaces.heart_disease_risk_model import HeartDiseaseRiskModelPort
...
class HeartDiseaseRiskAssessmentService(BaseService):
    """On-demand heart disease risk assessments scoped to one owned patient."""
    ...
    async def assess_heart_disease_risk(
        ...
        *,
        ...
        return HeartDiseaseRiskAssessmentDTO(
            patient_id=patient_id,
            date_from=window.date_from,
            date_to=window.date_to,
