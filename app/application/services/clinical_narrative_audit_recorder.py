"""Fail-open clinical narrative audit recording."""
...
async def record_clinical_narrative_audit_event(
    ...
    *,
    ...
    entry = AuditRecordInput(
        resource_type=AuditResourceType.CLINICAL_NARRATIVE,
    ...
    try:
        ...
        logger.exception(
            "Failed to persist clinical narrative audit event",
            extra={
                "audit_action": AuditAction.GENERATE.value,
