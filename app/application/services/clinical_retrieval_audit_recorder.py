"""Fail-open clinical retrieval audit recording."""
...
async def record_clinical_retrieval_audit_event(
    ...
    *,
    ...
    entry = AuditRecordInput(
        resource_type=AuditResourceType.CLINICAL_RETRIEVAL,
    ...
    try:
        ...
        logger.exception(
            "Failed to persist clinical retrieval audit event",
            extra={
                "audit_action": AuditAction.SEARCH.value,
