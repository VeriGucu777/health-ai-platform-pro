"""Diabetes risk assessment application DTOs."""
...
class DiabetesRiskAssessmentDTO(BaseSchema):
    """On-demand diabetes risk assessment for one owned patient."""
    ...
    disclaimer: str = DIABETES_RISK_DISCLAIMER
