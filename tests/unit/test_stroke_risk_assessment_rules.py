"""Unit tests for stroke risk feature extraction helpers."""
...
from app.application.analytics.stroke_risk_assessment import (
...
def test_build_feature_vector_extracts_glucose_and_stroke_history_types() -> None:
    window = _window()
    measurements = [
        _measurement(
    ...
    assert features.stroke_history_record_types == ("stroke_history",)


def test_detect_missing_inputs_flags_required_glucose_and_blood_pressure() -> None:
