#!/usr/bin/env python3
"""Seed unassigned demo patient in demo-live-policy-clinic (DATABASE_URL required)."""
...
from app.application.seeding.demo_unassigned_patient_fixture_seed import (  # noqa: E402
    ...
    DEMO_UNASSIGNED_PATIENT_GENDER,
...
from app.infrastructure.repositories.patient_repository import (
    SQLAlchemyPatientRepository,  # noqa: E402
)
from app.infrastructure.repositories.user_repository import SQLAlchemyUserRepository  # noqa: E402


def _config_from_env() -> DemoUnassignedPatientFixtureSeedConfig:
    return DemoUnassignedPatientFixtureSeedConfig(
        ...
        patient_first_name=os.getenv(
            "DEMO_UNASSIGNED_PATIENT_FIRST_NAME",
            DEMO_UNASSIGNED_PATIENT_FIRST_NAME,
        ),
        patient_last_name=os.getenv(
            "DEMO_UNASSIGNED_PATIENT_LAST_NAME",
            DEMO_UNASSIGNED_PATIENT_LAST_NAME,
        ),
        patient_gender=os.getenv("DEMO_UNASSIGNED_PATIENT_GENDER", DEMO_UNASSIGNED_PATIENT_GENDER),
        patient_seed_marker=os.getenv(
            "DEMO_UNASSIGNED_PATIENT_SEED_MARKER",
            DEMO_UNASSIGNED_PATIENT_SEED_MARKER,
        ),
    )
...
async def _run() -> int:
    ...
    print(
        "Demo unassigned patient fixture seed finished "
        f"(organization_id={result.organization_id}, patient_id={result.patient_id}, "
